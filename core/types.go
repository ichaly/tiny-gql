...
var stdTypes = []__Type{
	{
		...
		EnumValues: []__EnumValue{
			{Name: "children", Description: "Children of parent row"},
			{Name: "parents", Description: "Parents of current row"},
		},
	}, {
		Kind:        TK_ENUM,
		Name:        Direction,
		Description: "Result sort types",
		EnumValues: []__EnumValue{
			{Name: "asc", Description: "Ascending order"},
			{Name: "desc", Description: "Descending order"},
			{Name: "asc_nulls_first", Description: "Ascending nulls first order"},
			{Name: "desc_nulls_first", Description: "Descending nulls first order"},
			{Name: "asc_nulls_last", Description: "Ascending nulls last order"},
			{Name: "desc_nulls_last", Description: "Descending nulls last order"},
		},
	},
}
